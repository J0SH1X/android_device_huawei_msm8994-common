...
# GPS configuration
PRODUCT_COPY_FILES += \
    device/huawei/msm8994-common/configs/gps.conf:$(TARGET_COPY_OUT_SYSTEM)/etc/gps.conf:qcom
...
PRODUCT_COPY_FILES += \
    ...
    device/huawei/msm8994-common/vndk-v32-prebuild/arm64/vndk-core/libstagefright_foundation.so:$(TARGET_COPY_OUT_VENDOR)/lib64/libstagefright_foundation.so \
    device/huawei/msm8994-common/vndk-v32-prebuild/arm64/vndk-core/libhardware_legacy.so:$(TARGET_COPY_OUT_VENDOR)/lib64/libhardware_legacy.so \
